...
const Iot = () => {
  ...
  const getPhone = async() => {
         ...
         try{
           const res = await axios.get(`https://api.kontenbase.com/query/api/v1/9b5b9994-1cdd-4d45-af12-3e1f71a10c2c/Iots/${id}`);
           const iot = res.data;
           setProduct(iot)
  ...
  {/* Main */}
  <div className="flex flex-col  space-x-4 space-y-24 md:flex-row justify-center items-center pt-24 pb-24 border-b-2 border-slate-200">
          ...
          <div className="flex flex-col w-full md:w-1/2 items-center" >
              ...
              <span className="text-xs text-slate-800 font-light" style={{maxWidth:200}}>*Gambar produk hanya untuk referensi. Silahkan lihat produk yang sebenarnya</span>
          </div>
    </div>
